...
import { LogIn } from "lucide-react"; // Optional icon for polish
  ...
  return (
    <div className="flex min-h-screen bg-white">
      ...
      <div className="relative hidden w-0 flex-1 lg:block">
        ...
        />
        {/* Dark overlay to ensure image looks premium */}
        <div className="absolute inset-0 bg-blue-900/20 mix-blend-multiply" />
        
        {/* Optional Branding Text on Image */}
        <div className="absolute bottom-0 left-0 p-10 text-white z-10">
           <h2 className="text-4xl font-bold">DevConnect</h2>
           <p className="mt-2 text-lg text-white/90">Where developers build together.</p>
        </div>
      </div>
      ...
      <div className="flex flex-1 flex-col justify-center px-4 py-12 sm:px-6 lg:flex-none lg:px-20 xl:px-24 bg-white">
        <div className="mx-auto w-full max-w-sm lg:w-96">
          ...
          <div className="mt-8 text-center text-sm">
            <span className="text-gray-500">New to DevConnect? </span>
            <Link
              to="/register"
